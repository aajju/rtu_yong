...
xml_ok_namyangju02 = (                 
    ...
    "</detector>"
    "</XML>"
) % (site_id_namyangju02, site_id_namyangju02, site_id_namyangju02,site_id_namyangju02,site_id_namyangju02,site_id_namyangju02,site_id_namyangju02)




# 서부내륙추가(부여)
site_id_buyeo01 = "buyeo01"  # 채널5, 장비2
xml_ok_buyeo01 =  (
    "xmlText=<XML>"
    "<detector>"
    "<siteId>%s</siteId>"
