...
# 이것만 바꾸면 됨
siteId_string = "move02"     # 실제 현장 데이터 보내는 곳(코위드원)

siteId_string_ok = "siheung01"  # 언제나 ok 보내야하는 현장
# siteId_string_ok = "move02"  # 언제나 ok 보내야하는 현장
python_file = "siheung01.py"   # 파일명 동일하게 입력해야함
site_korean = "시흥 광역상수도"       # 슬랙메시지에 표현되는 문구
