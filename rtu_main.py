...
# 인커밍 웹훅 URL
webhook_url = (
    "https://hooks.slack.com/services/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"
)
                ...
                if det_num_int == 1 :
                    ...
                    if g_double_check_count >= MAX_DOUBLE_CHECK :
                        if check_status_change(ch_num_int-1) == 1:          #if status change, xml transfer immediately
                            ...
                            local_slack_count = local_slack_count + 1
                            print("local_slack_count ",local_slack_count)
                            if local_slack_count > MAX_CH * MAX_DET:
